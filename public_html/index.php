...
<div class="container-fluid">
  ...
  <div class="form-group">
      <label for="validationCustom03"><b>Usuario</b></label>
    <input type="text" name="username" class="form-control" id="validationCustom03" aria-describedby="emailHelp" placeholder="Ingresa Usuario">
  ...
  <div class="form-group">
    ...
    <br>
    <center><button type="submit" class="btn btn-dark" >Iniciar Sesión </button></a></center>
  </div>
</div>
