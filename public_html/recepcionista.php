  ...
  <div class="row">
    ...
    <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
      ...
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Dashboard Recepcionista</h1>
    ...
    <center>
    <a href="addcliente.php"><img class="icono" width="13%" src="img/add-user.png"></a>
    <a href="registrocliente.php"><img class="icono" width="13%" src="img/config-user.png"></a>
    <a href="imprimircliente.php"><img class="icono" width="13%" src="img/print-user.png"></a>
    </center>
</div>
